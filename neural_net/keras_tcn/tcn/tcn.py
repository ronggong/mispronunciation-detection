...
def residual_block(x, s, i, activation, nb_filters, kernel_size, dropout):
    original_x = x
...
def dilated_tcn(num_feat, num_classes, nb_filters,
                kernel_size, dilatations, nb_stacks, max_len, dropout,
    ...
    for s in range(nb_stacks):
        for i in dilatations:
            x, skip_out = residual_block(x, s, i, activation, nb_filters, kernel_size, dropout)
