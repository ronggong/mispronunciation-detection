...
if __name__ == '__main__':
    ...
    if cv_prod == "cv":
        ...
        for ii, (train_index, val_index) in enumerate(skf.split(X_special, y_special)):
            ...
            model_name = 'special_model_{}_{}_{}'.format(attention, conv, dropout)
        ...
        with open(os.path.join(path_model, 'log', 'special_results_{}_{}_{}.txt'.format(attention, conv, dropout)), 'w') as f:
        ...
        model_name = 'special_model_prod_{}_{}_{}'.format(attention, conv, dropout)
